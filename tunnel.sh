...
ssh -L 5555:devpgsql.postgres.database.azure.com:5432 -i ~/.ssh/gcc_dw_azure gccdatauser@data-science-vm-linux-ip.uksouth.cloudapp.azure.com -N -vvv >logs/tunnel.log 2>&1 &
